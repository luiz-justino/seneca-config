...
Configuration plugin for Seneca microservices.

## Support

If you're using this module and need help, you can:

- Post a [github issue](https://github.com/senecajs/seneca-config/issues)
- Tweet to [@senecajs](http://twitter.com/senecajs)
- Ask on the [Gitter](https://gitter.im/senecajs/seneca)

## API

See [source](https://github.com/senecajs/seneca-config) for API details.

> **Note:** This package has been replaced by [SenecaConfig](https://github.com/senecajs/SenecaConfig).
...
**Note:** This package has been superseded by [SenecaConfig](https://github.com/senecajs/SenecaConfig).
